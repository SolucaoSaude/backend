...
public class UserContext {
    ...
    @Getter private final PacienteDTO user;
    ...
    public static UserContext create(String username, List<GrantedAuthority> authorities, PacienteDTO user, RawAccessJwtToken rawAccessToken) {
